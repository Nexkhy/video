                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex action-button">
                                    <?php if ($user->statut == 'pending' && $user->role == 'medecin') : ?>
                                        <a href="index.php?view=user.control&action=valider_medecin&id=<?= $user->iduser ?>" class="btn btn-success btn-xs light px-2 mr-2" title="Valider l'inscription">
                                    ...
                                    <a href="<?= $delete ?>" class="ml-2 btn btn-xs px-2 light btn-danger" onclick="return confirm('Voulez-vous vraiment supprimer cet utilisateur ?');">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
